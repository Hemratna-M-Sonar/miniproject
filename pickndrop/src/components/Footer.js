...
const Footer = () => {
    return(
        <>
            <div className="w-full min-h-[90vh] flex items-center justify-center bg-black">
                <div className="md:w-2/3 w-full px-4 text-white flex flex-col">
                    ...
                    <div className="flex mt-8 flex-col md:flex-row md:justify-between">
                        ...
                        <div className="w-44 pt-6 md:pt-0">
                            <NavLink to="/" className="bg-white text-black justify-center text-center rounded-lg shadow px-7 font-bold py-3 flex items-center">Contact us</NavLink>
                        </div>
                    </div>
                    <div className="flex flex-col">
                        <div className="flex mt-24 mb-12 flex-row justify-between">
                            <div className="w-25 mt-[-8px]">
                                <img className="lg:block logoImage" src="images/logo.png" alt="Your Company" />
                            </div>
                            <NavLink to="/" className="hidden md:block cursor-pointer text-gray-600 hover:text-white">About</NavLink>
                            <NavLink to="/" className="hidden md:block cursor-pointer text-gray-600 hover:text-white">Services</NavLink>
                            <NavLink to="/" className="hidden md:block cursor-pointer text-gray-600 hover:text-white">Safety</NavLink>
                            <NavLink to="/" className="hidden md:block cursor-pointer text-gray-600 hover:text-white">Help</NavLink>
                            <div className="mt-[-8px] flex flex-row space-x-8 items-center justify-between">
                                <NavLink to="/">
                        ...
                        <p className="w-full text-center my-12 text-gray-600">Copyright © 2022 Pick N Drop Pvt. Ltd.</p>
                    </div>
                </div>
            </div>
        </>
